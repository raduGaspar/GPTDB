...
var GPTDB = function (filePath, initialData) {
  ...
  var watchers = [];
  var notify = function (path, oldValue, newValue) {
  ...
  var data = (0, utils_1.createProxy)(initialData, notify);
  function read() {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            error_2 = _a.sent();
            console.error('Error writing to the file: '.concat(error_2));
            return [3 /*break*/, 3];
          case 3:
            return [2 /*return*/];
        }
    ...
    function traverse(obj, currentPath) {
      ...
      for (var key in obj) {
        ...
        if (predicate(value, newPath.join('.'))) {
          results.push({ value: value, path: newPath.join('.') });
        }
